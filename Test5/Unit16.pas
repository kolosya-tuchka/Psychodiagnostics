...
begin
 ...
 ADOQuery1.Close;
       ...
       if (ADOQuery1.RecordCount = 0) then begin
         ...
         ADOQuery1.FieldByName('Name_Test').AsString:='Шкала поиска острых ощущений.';
         ...
         ADOQuery1.Close;
         ADOQuery1.SQL.Clear;
         ADOQuery1.SQL.Add('SELECT Name_test FROM Test_app where Name_test="Шкала поиска острых ощущений."');
         ADOQuery1.open;
         ADOQuery1.First;
         if (ADOQuery1.RecordCount = 0) then begin
         ADOQuery1.SQL.Clear;
         ...
         ADOQuery1.SQL.Clear;
         ADOQuery1.SQL.Add('SELECT * FROM Test_app where Name_test="Флегматик, меланхолик, холерик, сангвиник - кто вы?"');
         ADOQuery1.open;
         ADOQuery1.First;
