...
uses Unit32, Unit31, Unit30, Unit29, Unit34, Unit35, Unit41, Unit1, Unit40,
  Unit42, Unit43, Unit10, Unit44, Unit45, StartTest, Unit62;
...
if (Form29.HasText.Checked) then begin
   Form34.Show;
end
else begin
  Form34.Button1Click(Form33);
end;
...
begin
   ...
   number:=ListBox1.ItemIndex;
   label3.Caption:=IntToStr(number+1);
