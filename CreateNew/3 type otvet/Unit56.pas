...
uses Unit37, Unit35, Unit34, Unit39, Unit28, StartTest, Unit55, Unit78;
    ...
    begin
       with MyModule.ADOQuery2 do
        begin
          ...
          SQL.Text:= squery;
          open;
          bal1:=Fields[0].AsInteger;
          bal2:=Fields[1].AsInteger;
          bal3:=Fields[2].AsInteger;
          bal4:=Fields[3].AsInteger;
        end;
