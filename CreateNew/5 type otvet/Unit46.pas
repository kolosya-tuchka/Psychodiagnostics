...
uses Unit33, Unit34, Unit47, Unit1, Unit29, Unit30, StartTest, Unit62, Unit4,
  Unit35, Unit12;
...
begin
  ...
  list.Items.Add(memo.Lines.Text);
  memo.Lines.Clear;
end;

   list_vopros.Items.Add(memo_vopros.Lines.Text);
