...
uses Unit35, Unit34, Unit37, Unit39, Unit28, Unit38, StartTest, Unit25;
       ...
       begin
        with MyModule.ADOQuery2 do
          begin
             Close;
             SQL.clear;
             squery:='Select bal1,bal2,bal3,bal4,bal5 from Test_Information where N_1='+IntToStr(metka+i);
             SQL.Text:= squery;
             open;
             bal1:=MyModule.ADOQuery2.Fields[0].AsInteger;
             bal2:=MyModule.ADOQuery2.Fields[1].AsInteger;
